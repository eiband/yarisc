...
namespace yarisc::arch
{
  namespace detail
  {
    ...
    inline constexpr std::array<instruction_descriptor, num_opcodes> instruction_table{{
      ...
      /* 0x11 */ {"ADDS", feature_level::min, optype::op0_op1_op2},
      /* 0x12 */ {"ADC", feature_level::min, optype::op0_op1_op2},
      /* 0x13 */ {"ADCS", feature_level::min, optype::op0_op1_op2},
      /* 0x14 */ {"SUB", feature_level::min, optype::op0_op1_op2},
      /* 0x15 */ {"SUBS", feature_level::min, optype::op0_op1_op2},
      /* 0x16 */ {"SBC", feature_level::min, optype::op0_op1_op2},
      /* 0x17 */ {"SBCS", feature_level::min, optype::op0_op1_op2},
      /* 0x18 */ {},
      /* 0x19 */ {},
      /* 0x1a */ {},
      /* 0x1b */ {},
      ...
      /* 0x28 */ {},
      /* 0x29 */ {},
      /* 0x2a */ {"CMP", feature_level::min, optype::op0_op1},
      /* 0x2b */ {"BRA", feature_level::v1, optype::branch},
